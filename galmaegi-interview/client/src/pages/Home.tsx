...
const scenes = [
  {
    ...
    title: "연출 소개",
    shortTitle: "소개",
    image: "/manus-storage/intro_c3dd58c5.png",
    alt: "갈매기 빛 그리고 사랑을 소개하는 박성아 연출의 메시지 이미지",
  },
  {
    id: "message",
    index: "02",
    eyebrow: "NOTE TO THE AUDIENCE",
    title: "관객에게 주는 메시지",
    shortTitle: "메시지",
    image: "/manus-storage/message_6e613ae0.png",
  ...
  },
  {
    ...
    title: "갈매기를 연출하게 된 이유",
    shortTitle: "이유",
    image: "/manus-storage/reason_e7defa4e.png",
  ...
  },
  {
    ...
    title: "연출하면서 힘들었던 기억",
    shortTitle: "어려움",
    image: "/manus-storage/hardship_7fbb9b35.png",
  ...
  },
  {
    ...
    title: "연출하면서 재미있었던 기억",
    shortTitle: "즐거움",
    image: "/manus-storage/fun_1867ac2a.png",
  ...
  },
  {
    ...
    title: "기억나는 에피소드",
    shortTitle: "에피소드",
    image: "/manus-storage/episode_ca0751e4.png",
  ...
  },
  {
    ...
    title: "보러 와주신 관객들에게 한마디",
    shortTitle: "마지막 인사",
    image: "/manus-storage/audience_2b130fb1.png",
    ...
    <main className="reader-shell">
      ...
      <header className="reader-header">
        <a className="brand-mark" href="#prologue" aria-label="갈매기 인터뷰 처음으로">
          <img src="/manus-storage/galmaegi-mark_2da1217d.png" alt="" />
          <span>갈매기</span>
        </a>
        <p className="header-note">빛 그리고 愛 · 연출 박성아</p>
      ...
      <section className="opening-note" aria-label="읽기 안내">
        <div className="opening-title">
          <img src="/manus-storage/galmaegi-mark_2da1217d.png" alt="" />
          <div className="opening-current">갈매기, 빛 그리고 愛</div>
        </div>
        <div>
      ...
      <footer className="reader-closing">
        ...
        <div className="closing-copy">
          ...
          <h2>마지막 장면 뒤에도<br />빛은 오래 남습니다.</h2>
          <p>갈매기, 빛 그리고 愛</p>
        </div>
      </footer>
    </main>
